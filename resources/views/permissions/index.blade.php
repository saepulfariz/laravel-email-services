    ...
    <div class="card p-0 shadow-none">
        <div class="table-wrapper border-none rounded-xl">
            <table>
                <thead>
                    <tr>
                        <th><a href="{{ sortUrl('name') }}" class="flex items-center no-underline hover:text-ink">Permission Name {!! sortIcon('name') !!}</a></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex gap-2">
                                    <a href="{{ route('permissions.edit', $permission->id) }}" class="btn-ghost px-2 py-1 text-[13px] border border-hairline">Edit</a>
                                    
                                    <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST" class="m-0 form-delete">
                                        @csrf
                                        @method('DELETE')
